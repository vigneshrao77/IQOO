...
import { LayoutDashboard, ListChecks, PieChart, PhoneCall, BookOpen, SquarePen, MessageSquare, HelpCircle } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { label: 'F/Q', path: '/student/project?tab=faq', icon: HelpCircle },
